...
insert into sys_org_unit (id, parent_id, ancestors, org_code, org_name, org_type, sort, leader_user_id, status, create_by, create_time, update_by, update_time, note) values (9001, 0, '0', 'SOLI_HQ', '总公司', 'HEADQUARTERS', 1, 1, '0', 'system', now(), null, null, '岗位管理根组织节点');
insert into sys_org_unit (id, parent_id, ancestors, org_code, org_name, org_type, sort, leader_user_id, status, create_by, create_time, update_by, update_time, note) values (9002, 9001, '0,9001', 'SOLI_EAST', '华东分公司', 'BRANCH', 1, 3, '0', 'system', now(), null, null, '华东业务组织节点');

insert into sys_org_post (id, org_unit_id, parent_post_id, ancestors, post_code, post_name, post_type, manager_user_id, sort, status, create_by, create_time, update_by, update_time, note) values (9101, 9001, 0, '0', 'PURCHASE_CENTER', '采购中心', 'MANAGER', 1, 1, '0', 'system', now(), null, null, '总公司采购中心');
insert into sys_org_post (id, org_unit_id, parent_post_id, ancestors, post_code, post_name, post_type, manager_user_id, sort, status, create_by, create_time, update_by, update_time, note) values (9102, 9001, 9101, '0,9101', 'BUYER', '采购员', 'BUYER', 2, 1, '0', 'system', now(), null, null, '采购执行岗位');
insert into sys_org_post (id, org_unit_id, parent_post_id, ancestors, post_code, post_name, post_type, manager_user_id, sort, status, create_by, create_time, update_by, update_time, note) values (9103, 9002, 0, '0', 'SALES_CENTER', '销售中心', 'MANAGER', 3, 1, '0', 'system', now(), null, null, '华东销售中心');
...
delete from sys_module_field_title;
...
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010101, 101, 10101, 'HEADER', 'supplierName', '供应商名称', 'search-select', 'header.supplierName', 'string', '1', 1, '0', 'system', now(), null, null, '支持按名称、编码联想选择');
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010102, 101, 10101, 'HEADER', 'sourceBillNo', '来源单号', 'input', 'header.sourceBillNo', 'string', '0', 2, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010103, 101, 10101, 'HEADER', 'sourceType', '来源类型', 'tag', 'header.sourceType', 'string', '0', 3, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010104, 101, 10101, 'HEADER', 'amount', '订单金额', 'amount', 'header.amount', 'decimal', '1', 4, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010301, 101, 10103, 'HEADER', 'status', '单据状态', 'tag', 'header.status', 'string', '1', 1, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010302, 101, 10103, 'HEADER', 'auditUserName', '审核人', 'text', 'header.auditUserName', 'string', '0', 2, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010303, 101, 10103, 'HEADER', 'auditTime', '审核时间', 'datetime', 'header.auditTime', 'datetime', '0', 3, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010201, 101, 10102, 'DETAIL', 'materialName', '物料名称', 'search-select', 'detail.items.materialName', 'string', '1', 1, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010202, 101, 10102, 'DETAIL', 'qty', '数量', 'number', 'detail.items.qty', 'decimal', '1', 2, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010203, 101, 10102, 'DETAIL', 'price', '单价', 'amount', 'detail.items.price', 'decimal', '1', 3, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (1010204, 101, 10102, 'DETAIL', 'lineAmount', '行金额', 'amount', 'detail.items.lineAmount', 'decimal', '1', 4, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010101, 201, 20101, 'HEADER', 'customerName', '客户名称', 'search-select', 'header.customerName', 'string', '1', 1, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010102, 201, 20101, 'HEADER', 'amount', '订单金额', 'amount', 'header.amount', 'decimal', '1', 2, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010103, 201, 20101, 'HEADER', 'status', '单据状态', 'tag', 'header.status', 'string', '1', 3, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010104, 201, 20101, 'HEADER', 'auditUserName', '审核人', 'text', 'header.auditUserName', 'string', '0', 4, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010105, 201, 20101, 'HEADER', 'auditTime', '审核时间', 'datetime', 'header.auditTime', 'datetime', '0', 5, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010201, 201, 20102, 'DETAIL', 'goodsName', '商品名称', 'search-select', 'detail.items.goodsName', 'string', '1', 1, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010202, 201, 20102, 'DETAIL', 'qty', '数量', 'number', 'detail.items.qty', 'decimal', '1', 2, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010203, 201, 20102, 'DETAIL', 'price', '单价', 'amount', 'detail.items.price', 'decimal', '1', 3, '0', 'system', now(), null, null, null);
insert into sys_module_field (id, module_id, tab_id, field_scope, field_code, default_title, component_type, data_path, value_type, required_flag, sort, status, create_by, create_time, update_by, update_time, note) values (2010204, 201, 20102, 'DETAIL', 'lineAmount', '行金额', 'amount', 'detail.items.lineAmount', 'decimal', '1', 4, '0', 'system', now(), null, null, null);

insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011101, 1010101, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '供应商名称字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011102, 1010102, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '来源单号字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011103, 1010103, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '来源类型字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011104, 1010104, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '订单金额字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011301, 1010301, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '单据状态字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011302, 1010302, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '审核人字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011303, 1010303, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '审核时间字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011201, 1010201, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '物料名称字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011202, 1010202, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '数量字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011203, 1010203, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '单价字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (1011204, 1010204, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '行金额字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011101, 2010101, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '客户名称字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011102, 2010102, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '订单金额字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011103, 2010103, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '单据状态字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011104, 2010104, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '审核人字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011105, 2010105, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '审核时间字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011201, 2010201, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '商品名称字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011202, 2010202, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '数量字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011203, 2010203, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '单价字段标题默认记录');
insert into sys_module_field_title (id, field_id, locale, display_title, placeholder, help_text, status, create_by, create_time, update_by, update_time, note) values (2011204, 2010204, 'zh_CN', null, null, null, '0', 'system', now(), null, null, '行金额字段标题默认记录');
