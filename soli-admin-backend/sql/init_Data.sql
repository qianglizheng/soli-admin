...
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4001, 3001, '男', '0', 1, null, 'primary', 'N', '0', 'system', now(), null, null, '用户性别男');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4002, 3001, '女', '1', 2, null, 'danger', 'N', '0', 'system', now(), null, null, '用户性别女');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4003, 3001, '未知', '2', 3, null, 'info', 'Y', '0', 'system', now(), null, null, '用户性别未知');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4004, 3002, '显示', '0', 1, null, 'success', 'Y', '0', 'system', now(), null, null, '菜单显示');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4005, 3002, '隐藏', '1', 2, null, 'warning', 'N', '0', 'system', now(), null, null, '菜单隐藏');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4006, 3003, '正常', '0', 1, null, 'success', 'Y', '0', 'system', now(), null, null, '系统正常状态');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4007, 3003, '停用', '1', 2, null, 'danger', 'N', '0', 'system', now(), null, null, '系统停用状态');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4008, 3004, '是', 'Y', 1, null, 'success', 'Y', '0', 'system', now(), null, null, '是否字典是');
insert into sys_dict_data (id, dict_type_id, label, value, sort, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, note) values (4009, 3004, '否', 'N', 2, null, 'info', 'N', '0', 'system', now(), null, null, '是否字典否');